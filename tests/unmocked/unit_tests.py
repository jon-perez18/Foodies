...
from app import get_event_info
RECS_INPUT = "address"
...
class UpdateUserTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.success_test_params2 = [
            {
                RECS_INPUT: {'event_name': 'Bday', 'event_description': 'Bday', 'event_date': '2021-04-29', 'event_time': '20:14'},
                EXPECTED_OUTPUT: '8:14 PM'
            },
            {
                RECS_INPUT: {'event_name': 'date', 'event_description': 'date night', 'event_date': '2021-07-14', 'event_time': '06:10'},
                EXPECTED_OUTPUT: '06:10 AM'
            },
            {
                RECS_INPUT: {'event_name': 'funeral', 'event_description': 'funeral :(', 'event_date': '2021-01-01', 'event_time': '12:00'},
                EXPECTED_OUTPUT: '12:00 AM'
            }
        ]
    ...
    def test_time(self):
        for test in self.success_test_params2:
            # TODO: Make a call to add user with your test inputs
            # then assign it to a variable
            actual_result = get_event_info(test[RECS_INPUT])
